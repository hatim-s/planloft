...
outside the consumer install and npm package surface. Keep README, skills, and CLI help
focused on shipped behavior.
...
| [0008](./0008-single-skill-command-knowledge.md) | single skill, authoritative command knowledge, and dual-theme output | Accepted (G1 and G6 amended by 0015; supersedes 0002 E4; amends 0001) |
...
| [0012](./0012-installation-products-and-external-installer.md) | installation products and the external skills installer | Accepted (inventory amended by 0015 and 0016; amends 0001 D1 and D23, 0008 G6) |
